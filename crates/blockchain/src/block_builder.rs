...
mod tests {
    ...
    fn build_block_caps_attestation_data_entries() {
        ...
        // The merged proof is opaque to this test; an empty envelope suffices
        // for the SSZ size check that follows.
        let _attestation_sigs: Vec<TypeOneMultiSignature> = signatures;
