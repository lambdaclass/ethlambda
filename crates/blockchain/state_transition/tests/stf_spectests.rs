...
///
/// While this is `true` every vector is skipped before it runs, so
/// `PROCESS_BLOCK_ONLY_TESTS` below has no effect yet; it takes over as soon as
/// the fixtures are regenerated and this flag is cleared.
